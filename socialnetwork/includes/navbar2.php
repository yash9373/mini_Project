<div class="usernav">
    ...
    <ul> <!-- Ensure there are no enter escape characters.-->
        <li><a href="requests1.php">Requests (<?php echo $row['count'] ?>)</a></li><li><a href="profile1.php">Profile</a></li><li><a href="friends1.php">Friends</a></li><li><a href="home1.php">Home</a></li><li><a href="logout.php">Log Out</a></li>
    </ul>
